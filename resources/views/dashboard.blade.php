<x-app-layout>
    ...
    <div class="bg-gray-800 text-white py-3 px-4 text-center fixed left-0 bottom-0 right-0 z-40">
        This a Timeline by rswebdesigner.
        <a class="underline text-gray-200" href="https://tailwindcomponents.com/component/timeline">Component details</a>
    </div>
    <div class="font-sans">
        <div class="bg-white max-w-md mx-auto my-8 border border-grey-light rounded-t-lg overflow-hidden">
            <div class="flex flex-wrap no-underline text-black h-64 overflow-hidden">
                <div class="w-3/4 h-full">
                    <img class="block pr-px w-full h-full" src="https://pbs.twimg.com/media/DRKabGUW0AA4yzH.jpg:large" alt="" style="object-fit: cover;">
                </div>
                <div class="w-1/4 h-full">
                    <div class="bg-grey-darkest mb-px h-32">
                        <img class="block w-full h-full" src="https://pbs.twimg.com/media/DRKabdIX0AAN-Pa.jpg" alt="" style="object-fit: cover;">
                    </div>
                    <div class="bg-grey-darkest h-32">
                        <img class="block w-full h-full" src="https://pbs.twimg.com/media/DRKacEZWkAAg0-l.jpg" alt="" style="object-fit: cover;">
                    </div>
                </div>
            </div>
            <div class="flex pt-4 px-4">
        ...
        <div class="bg-white max-w-md mx-auto my-8 border border-grey-light">
            <div class="flex pt-4 px-4">
                ...
                <div class="px-2 pt-2 flex-grow">
                    ...
                    <footer class="border-t border-grey-lighter text-sm flex">
                        <a href="#" class="block no-underline text-black flex px-4 py-2 items-center hover:bg-grey-lighter">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-thumbs-up h-6 w-6 mr-1">
                                <path d="M14 9V5a3 3 0 0 0-3-3l-4 9v11h11.28a2 2 0 0 0 2-1.7l1.38-9a2 2 0 0 0-2-2.3zM7 22H4a2 2 0 0 1-2-2v-7a2 2 0 0 1 2-2h3"></path>
                            </svg>
                            <span>Like</span>
                        </a>
        ...
        <div class="bg-white max-w-md mx-auto my-8 border border-grey-light">
            <a href="https://uxplanet.org/redesign-neiman-marcus-ios-app-5a0db3119b36" class="block border-b border-grey-light no-underline text-black">
                <img src="https://cdn-images-1.medium.com/max/1000/1*0SiPB4-TouBdJCpVwGwLdw.png" alt="">
                <div class="p-4">
                    <h2 class="font-medium text-lg mb-2">How I Redesign - Neiman Marcus iOS App</h2>
                    <p class="leading-normal mb-4 text-grey-darker">
